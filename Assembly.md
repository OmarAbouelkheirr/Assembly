...
`.data x DB 5 ; متغير اسمه x، نوعه Byte، قيمته 5 msg DB 'A' ; متغير اسمه msg، نوعه Byte، قيمته الحرف 'A' num DW 100 ; متغير اسمه num، نوعه Word، قيمته 100 text DB 'Hello' ; متغير اسمه text، نوعه سلسلة، قيمته "Hello"`
...
`.code MOV AX, @data ; خزن عنوان بداية الـ Data Segment في AX MOV DS, AX ; انسخ العنوان من AX إلى DS`
...
#### 5. **طباعة سطر جديد**:
- بنستخدم **Function 02h** عشان نطبع **Carriage Return (0Dh)** و**Line Feed (0Ah)**:
```
MOV AH, 02h
MOV DL, 0Dh 
INT 21h 
